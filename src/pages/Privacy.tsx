...
export const Privacy: React.FC = () => {
  return (
    <div className="min-h-screen bg-gray-50">
      <SEOHead
        title="Privacy Policy | Stigg Security Inc."
        description="Review how we collect, store, and protect your personal data in compliance with Canadian privacy laws."
        keywords="privacy policy, data protection, canadian privacy laws"
          ...
          <div className="prose prose-lg max-w-none">
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-700 mb-4">
                Stigg Security Inc. collects information you provide directly to us, such as when you:
              </p>
            ...
            <section className="mb-8">
              ...
              <ul className="list-disc pl-6 text-gray-700 mb-4">
                ...
                <li>Communicate with you about our services and security updates</li>
              </ul>
            </section>
